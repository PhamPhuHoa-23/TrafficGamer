...
class QCNet(pl.LightningModule):
    ...
    def validation_step(self,
        ...
        # v0_x = 5*math.cos(2.8)
        # v0_y = 5*math.sin(2.8)
        # new_input_data=add_new_agent(data,0.3, v0_x, v0_y, 2.8, 5208, 129)
        # v0_x = 5*math.cos(2.8)
        # v0_y = 5*math.sin(2.8)
        # new_input_data=add_new_agent(new_input_data,0.3, v0_x, v0_y, 2.8, 5208, 125)
        # v0_x = 5*math.cos(-1.2)
        # v0_y = 5*math.sin(-1.2)
        # new_input_data=add_new_agent(new_input_data,0.3, v0_x, v0_y, -1.2, 5183, 159)
        # v0_x = 5*math.cos(-1.2)
        # v0_y = 5*math.sin(-1.2)
